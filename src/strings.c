...
const u8 gText_DexCategory_GrasslandPkmn[] = _("POKéMON Dataran");
...
const u8 gText_DexCategory_MountainPkmn[] = _("POKéMON Gunung");
...
const u8 gText_TypeMode[] = _("MODE TYPE");
...
const u8 gText_PickOKExit[] = _("{DPAD_UPDOWN}PILIH {A_BUTTON}OK {B_BUTTON}BATAL");
const u8 gText_5Dashes[] = _("-----");
const u8 gText_PickFlipPageCheckCancel[] = _("{DPAD_LEFTRIGHT}PICK{PLUS}FLIP PAGE {A_BUTTON}CEK {B_BUTTON}BATAL");
...
const u8 gText_CancelPreviousData[] = _("{A_BUTTON}KEMBALI {B_BUTTON}MUNDUR");
