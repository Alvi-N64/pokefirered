...
const u8 gText_EggNickname[] = _("TELUR");
const u8 gText_MenuPokemon[] = _("POKéMON");
const u8 gText_NewGame[] = _("MULAI");
const u8 gText_Continue[] = _("LANJUT");
const u8 gTextJP_Options[] = _("せっていを かえる");
const u8 gUnusedText_MysteryGift[] = _("MYSTERY GIFT");
const u8 gText_MysteryGift[] = _("HADIAH MISTERI");
...
const u8 gText_MainMenuTime[] = _("WAKTU");
...
const u8 gText_Controls[] = _("KENDALI");
ALIGNED(4) const u8 gText_PickOk[] = _("{DPAD_UPDOWN}えらぶ {A_BUTTON}けってい");
ALIGNED(4) const u8 gText_ABUTTONNext[] = _("{A_BUTTON}LANJUT");
ALIGNED(4) const u8 gText_ABUTTONNext_BBUTTONBack[] = _("{A_BUTTON}LANJUT {B_BUTTON}KEMBALI");
ALIGNED(4) const u8 gText_UPDOWNPick_ABUTTONNext_BBUTTONBack[] = _("{DPAD_UPDOWN}PILIH {A_BUTTON}LANJUT {B_BUTTON}KEMBALI");
ALIGNED(4) const u8 gText_UPDOWNPick_ABUTTONBBUTTONCancel[] = _("{DPAD_UPDOWN}PILIH {A_BUTTON}{B_BUTTON}KEMBALI");
ALIGNED(4) const u8 gText_ABUTTONExit[] = _("{A_BUTTON}TUTUP");
const u8 gText_Boy[] = _("COWOK");
const u8 gText_Girl[] = _("CEWEK");
const u8 gText_PokedexTableOfContents[] = _("POKéDEX      DAFTAR ISI");
const u8 gText_PickOK[] = _("{DPAD_UPDOWN}PILIH {A_BUTTON}BUKA");
const u8 gText_Seen[] = _("Dilihat:");
const u8 gText_Owned[] = _("Dimiliki:");
const u8 gText_Kanto[] = _("KANTO");
const u8 gText_National[] = _("NASIONAL");
const u8 gText_PokemonHabitats[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}HABITAT POKéMON");
const u8 gText_DexCategory_GrasslandPkmn[] = _("Daerah Rerumputan");
const u8 gText_DexCategory_ForestPkmn[] = _("Daerah Hutan");
const u8 gText_DexCategory_WatersEdgePkmn[] = _("Daerah Perairan");
const u8 gText_DexCategory_SeaPkmn[] = _("Daerah Laut");
const u8 gText_DexCategory_CavePkmn[] = _("Daerah Gua");
const u8 gText_DexCategory_MountainPkmn[] = _("Daerah Pegunungan");
const u8 gText_DexCategory_RoughTerrainPkmn[] = _("Daerah Bebatuan");
const u8 gText_DexCategory_UrbanPkmn[] = _("Daerah Kota");
const u8 gText_DexCategory_RarePkmn[] = _("Langka");
const u8 gText_Search[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}CARI");
const u8 gText_NumericalMode[] = _("MODE NUMERIK");
const u8 gText_AToZMode[] = _("MODE A KE Z");
const u8 gText_PokedexOther[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}LAINNYA");
const u8 gTextJP_HowToUsePokedex[] = _("ずかんの つかいかた");
const u8 gText_ClosePokedex[] = _("TUTUP POKéDEX");
const u8 gText_TypeMode[] = _("MODE TIPE");
const u8 gText_LightestMode[] = _("MODE TERINGAN");
const u8 gText_SmallestMode[] = _("MODE TERKECIL");
const u8 gText_PokemonList[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}DAFTAR POKéMON");
const u8 gText_NumericalModeKanto[] = _("MODE NUMERIK: KANTO");
const u8 gText_NumericalModeNational[] = _("MODE NUMERIK: NASIONAL");
const u8 gText_PokemonListNoColor[] = _("DAFTAR POKéMON");
const u8 gText_SearchNoColor[] = _("CARI");
const u8 gText_PickOKExit[] = _("{DPAD_UPDOWN}PILIH {A_BUTTON}BUKA {B_BUTTON}KEMBALI");
const u8 gText_5Dashes[] = _("-----");
const u8 gText_PickFlipPageCheckCancel[] = _("{DPAD_LEFTRIGHT}PILIH{PLUS}PINDAH {A_BUTTON}BUKA {B_BUTTON}KEMBALI");
const u8 gText_PokedexPokemon[] = _("POKéMON ");
const u8 gText_HT[] = _("TB");
const u8 gText_WT[] = _("BB");
const u8 gText_PokedexQuotationMark[] = _("”"); // Unused
const u8 gText_Lbs[] = _("lbs."); // Ga dipake, balik ke "kg"
const u8 gTextJP_PokemonData[] = _("ポケモンデ-タ");
const u8 gText_Cry[] = _("{START_BUTTON}SUARA");
const u8 gText_NextDataCancel[] = _("{A_BUTTON}LANJUT {B_BUTTON}KEMBALI");
const u8 gText_Next[] = _("{A_BUTTON}LA NUT");
const u8 gText_CancelPreviousData[] = _("{A_BUTTON}TUTUP {B_BUTTON}MUNDUR");
const u8 gText_Area[] = _("LOKASI");
const u8 gText_Size[] = _("UKURAN");
const u8 gText_AreaUnknown[] = _("LOKASI ???");
const u8 gText_PokedexNo[] = _("{NO}");
const u8 gText_Page[] = _("HALAMAN");
...
const u8 gText_LeagueChamp[] = _("JUARA LIGA!\nSELAMAT!");
ALIGNED(4) const u8 gText_Number[] = _("No. ");
ALIGNED(4) const u8 gText_Level[] = _("Lv. ");
ALIGNED(4) const u8 gText_Name[] = _("NAMA");
...
const u8 gSaveStatName_Badges[] = _("MEDALI");
const u8 gSaveStatName_Pokedex[] = _("POKéDEX");
const u8 gSaveStatName_Time[] = _("WAKTU");
const u8 gText_FlyToWhere[] = _("どこへ とびますか?");
const u8 gOtherText_Use[] = _("PAKAI");
const u8 gOtherText_Toss[] = _("BUANG");
const u8 gOtherText_Register[] = _("REGISTER");
const u8 gOtherText_Give[] = _("KASIH");
const u8 gMenuText_Confirm[] = _("けってい");
const u8 gOtherText_Walk[] = _("WALK");
const u8 gFameCheckerText_Cancel[] = _("KEMBALI");
const u8 gOtherText_Exit[] = _("TUTUP");
const u8 gString_Dummy[] = _("");
const u8 gText_Cancel7[] = _("キャンセル");
const u8 gText_Item[] = _("BARANG");
const u8 gText_Mail[] = _("SURAT");
const u8 gText_Take[] = _("AMBIL");
const u8 gText_Store[] = _("SIMPAN");
const u8 gOtherText_Check[] = _("CEK");
...
const u8 gText_MenuBag[] = _("TAS");
const u8 gText_MenuPokenav[] = _("ポケナビ");
const u8 gText_MenuPlayer[] = _("{PLAYER}");
const u8 gText_MenuSave[] = _("SIMPAN");
const u8 gText_MenuOption[] = _("ATUR");
const u8 gText_MenuExit[] = _("TUTUP");
const u8 gText_MenuRetire[] = _("BERHENTI");
const u8 gText_MenuSafariStats[] = _("{STR_VAR_1}/{STR_VAR_2}\nBALLS  {STR_VAR_3}");
const u8 gText_TimesStrVar1[] = _("×{STR_VAR_1}");
const u8 gText_Berry[] = _(" BERI");
const u8 gText_Coins[] = _("{STR_VAR_1} KOIN");
const u8 gText_Items2[] = _("BARANG");
const u8 gText_PokeBalls2[] = _("BOLA");
const u8 gText_KeyItems2[] = _("PENTING");
const u8 gText_DepositItem[] = _("DEPOSIT ITEM");
const u8 gText_CloseBag[] = _("TUTUP TAS");
...
const u8 gText_ItemCantBeHeld[] = _("{STR_VAR_1} tidak bisa dipegang.");
...
const u8 gText_OakForbidsUseOfItemHere[] = _("OAK: {PLAYER}!\nItu tidak bisa dipakai disini!{PAUSE_UNTIL_PRESS}");
const u8 gText_CantDismountBike[] = _("Kamu tidak bisa turun disini.{PAUSE_UNTIL_PRESS}");
const u8 gText_ItemfinderResponding[] = _("Eh?\nITEMFINDER merespon!\pAda sesuatu disekitar sini!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NopeTheresNoResponse[] = _("‥ ‥ ‥ ‥\nTidak ada respon.{PAUSE_UNTIL_PRESS}");
const u8 gText_CoinCase[] = _("KOIN mu:\n{STR_VAR_1}{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PlayerUsedVar2[] = _("{PLAYER} memakai\n{STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_UsedVar2WildRepelled[] = _("{PLAYER} memakai\n{STR_VAR_2}.\pPara POKéMON liar menjauh.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PlayedPokeFluteCatchy[] = _("Memainkan POKé FLUTE.\pIramanya bagus!{PAUSE_UNTIL_PRESS}");
const u8 gText_PlayedPokeFlute[] = _("Memainkan POKé FLUTE.");
const u8 gText_PokeFluteAwakenedMon[] = _("POKé FLUTE membangunkan POKéMON\nyang tertidur.{PAUSE_UNTIL_PRESS}");
const u8 gText_TMCase[] = _("KOTAK TM");
const u8 gText_Close[] = _("TUTUP");
...
const u8 gText_BerryPouch[] = _("KANTONG BERI");
...
const u8 gText_ShopQuit[] = _("DADAH!");
const u8 gText_InBagVar1[] = _("DI TAS:{FONT_SMALL} {STR_VAR_1}");
const u8 gText_QuitShopping[] = _("Berhenti belanja.");
...
const u8 gText_HereYouGoThankYou[] = _("Oke, ini!\nTerima kasih!");
...
const u8 gText_Enter[] = _("IKUT");
const u8 gText_NoEntry[] = _("TIDAK IKUT");
const u8 gText_Take2[] = _("AMBIL");
const u8 gText_Read2[] = _("BACA");
const u8 gText_Trade4[] = _("TUKAR");
...
const u8 gText_MoveToWhere[] = _("Pindah kemana?");
const u8 gText_TeachWhichPokemon[] = _("Ajarkan pada siapa?");
const u8 gText_UseOnWhichPokemon[] = _("Dipakai ke siapa?");
const u8 gText_GiveToWhichPokemon[] = _("Dikasih ke siapa?");
const u8 gText_DoWhatWithPokemon[] = _("{PKMN} mau diapakan?");
const u8 gText_NothingToCut[] = _("Tidak ada yang di POTONG.");
const u8 gText_CantSurfHere[] = _("Tidak bisa BERENANG disini!");
const u8 gText_AlreadySurfing[] = _("Kamu sedang BERENANG.");
const u8 gText_CantUseHere[] = _("Can't use that here.");
const u8 gText_RestoreWhichMove[] = _("Pulihkan yang mana?");
const u8 gText_BoostPp[] = _("Boost PP of which?");
const u8 gText_DoWhatWithItem[] = _("Diapakan barang ini?");
...
const u8 gText_ThreePkmnAreNeeded[] = _("Perlu tiga {PKMN}.");
const u8 gText_PokemonCantBeSame[] = _("{PKMN} tidak bisa sama.");
const u8 gText_NoIdenticalHoldItems[] = _("No same hold items!");
const u8 gText_CurrentIsTooFast[] = _("The current is much too fast!");
const u8 gText_DoWhatWithMail[] = _("Mau diapakan SURAT ini?");
const u8 gText_ChoosePokemonCancel[] = _("Pilih POKéMON atau BATAL.");
const u8 gText_ChoosePokemonConfirm[] = _("Pilih POKéMON dan lanjut.");
const u8 gText_TwoPokemonAreNeeded[] = _("Perlu dua POKéMON.");
...
const u8 gText_NotAble[] = _("TIDAK BISA");
const u8 gText_Able3[] = _("BISA!");
const u8 gText_NotAble2[] = _("TIDAK BISA!");
const u8 gText_Learned[] = _("SUDAH");
...
const u8 gText_CutATreeOrGrass[] = _("Memotong batang atau rumput.");
const u8 gText_FlyToAKnownTown[] = _("Terbang ke kota yang dikunjungi.");
const u8 gText_TravelOnWater[] = _("Menjelajahi perairan.");
const u8 gText_MoveHeavyBoulders[] = _("Mendorong batu berat.");
const u8 gText_LightUpDarkness[] = _("Menerangi kegelapan.");
const u8 gText_ShatterACrackedRock[] = _("Menghancurkan batu pecah.");
const u8 gText_ClimbAWaterfall[] = _("Memanjat air terjun.");
const u8 gText_DiveUnderwater[] = _("すいちゅうに もぐる");
const u8 gText_EscapeFromHere[] = _("Keluar dari sini.");
const u8 gText_LureWildPokemon[] = _("Memancing POKéMON liar.");
...
const u8 gText_ItemStorage[] = _("GUDANG");
const u8 gText_Mailbox[] = _("KOTAK SURAT");
const u8 gText_DepositItem2[] = _("SIMPAN BARANG");
const u8 gText_WithdrawItem2[] = _("AMBIL BARANG");
...
const u8 gOtherText_Read[] = _("BACA");
const u8 gOtherText_MoveToBag[] = _("TARUH KE TAS");
const u8 gOtherText_Give2[] = _("AMBIL");
const u8 gText_TheresNoMailHere[] = _("Tidak ada SURAT disini.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_BagIsFull[] = _("TAS nya penuh.{PAUSE_UNTIL_PRESS}");
const u8 gText_MailReturnedToBagMessageErased[] = _("The MAIL was returned to the BAG\nwith its message erased.{PAUSE_UNTIL_PRESS}");
const u8 gText_WithdrawItem[] = _("AMBIL\nBARANG");
const u8 gText_Withdraw[] = _("AMBIL");
...
const u8 gText_Eggs[] = _("TELUR");
const u8 gText_HallOfFame[] = _("HALL OF FAME");
const u8 gText_Victories[] = _("VICTORIES");
const u8 gText_Quit[] = _("TUTUP");
const u8 gText_Psn[] = _("RCN");
const u8 gText_Par[] = _("LPH");
const u8 gText_Slp[] = _("TDR");
const u8 gText_Brn[] = _("BKR");
const u8 gText_Frz[] = _("BKU");
const u8 gText_Toxic[] = _("WISA");
const u8 gText_OK[] = _("OK");
const u8 gOtherText_Quit[] = _("TUTUP");
...
const u8 gText_FreshWater_200[] = _("AIR PUTIH{CLEAR_TO 0x57}{FONT_SMALL}¥200");
const u8 gText_SodaPop_300[] = _("SODA POP{CLEAR_TO 0x57}{FONT_SMALL}¥300");
const u8 gText_Lemonade_350[] = _("ES LIMUN{CLEAR_TO 0x57}{FONT_SMALL}¥350");
const u8 gText_50Coins_1000[] = _("{FONT_SMALL} 50 KOIN{CLEAR_TO 0x45}¥1,000");
const u8 gText_500Coins_10000[] = _("{FONT_SMALL}500 KOIN{CLEAR_TO 0x40}¥10,000");
...
const u8 gText_Right[] = _("Kanan");
const u8 gText_Left[] = _("Kiri");
const u8 gText_Tm13_4000Coins[] = _("TM13{CLEAR_TO 0x48}{FONT_SMALL}4,000 KOIN");
const u8 gText_Tm23_3500Coins[] = _("TM23{CLEAR_TO 0x48}{FONT_SMALL}3,500 KOIN");
const u8 gText_Tm24_4000Coins[] = _("TM24{CLEAR_TO 0x48}{FONT_SMALL}4,000 KOIN");
const u8 gText_Tm30_4500Coins[] = _("TM30{CLEAR_TO 0x48}{FONT_SMALL}4,500 KOIN");
const u8 gText_Tm35_4000Coins[] = _("TM35{CLEAR_TO 0x48}{FONT_SMALL}4,000 KOIN");
const u8 gText_1F_2[] = _("L1");
const u8 gText_2F_2[] = _("L2");
const u8 gText_3F_2[] = _("L3");
const u8 gText_4F_2[] = _("L4");
const u8 gText_5F_2[] = _("L5");
...
const u8 gText_Items[] = _("BARANG");
const u8 gText_KeyItems[] = _("PENTING");
const u8 gText_PokeBalls[] = _("BOLA");
const u8 gText_TMsAndHMs[] = _("TM & HM");
const u8 gText_Berries[] = _("BERI");
const u8 gText_Boulderbadge[] = _("MEDALIBATU");
const u8 gText_Cascadebadge[] = _("MERALIAIR");
const u8 gText_Thunderbadge[] = _("MEDALIPETIR");
const u8 gText_Rainbowbadge[] = _("MEDALIWARNA");
const u8 gText_Soulbadge[] = _("MEDALISUKMA");
const u8 gText_Marshbadge[] = _("MEDALIRAWA");
const u8 gText_Volcanobadge[] = _("MEDALIMERAPI");
const u8 gText_Earthbadge[] = _("MEDALIBUMI");
const u8 gText_SomeoneSPc[] = _("PC SESEORANG");
const u8 gText_BillSPc[] = _("PC BILL");
const u8 gText_SPc[] = _("PC {PLAYER}");
const u8 gText_HallOfFame_2[] = _("HALL OF FAME");
const u8 gText_LogOff[] = _("LOG OFF");
const u8 gText_ProfOakSPc[] = _("PC PROF. OAK");
...
const u8 gText_FreshWater[] = _("AIR PUTIH");
const u8 gText_SodaPop[] = _("SODA POP");
const u8 gText_Lemonade[] = _("ES LIMUN");
const u8 gText_Coins_2[] = _("KOIN");
const u8 gText_Bicycle_Price[] = _("SEPEDA{CLEAR_TO 0x49}{FONT_SMALL}¥1,000,000");
const u8 gText_NoThanks[] = _("PERGI");
const u8 gText_Abra_180Coins[] = _("ABRA{CLEAR_TO 0x55}{FONT_SMALL} 180 KOIN");
const u8 gText_Clefairy_500Coins[] = _("CLEFAIRY{CLEAR_TO 0x55}{FONT_SMALL} 500 KOIN");
const u8 gText_Dratini_2800Coins[] = _("DRATINI{CLEAR_TO 0x4B}{FONT_SMALL} 2,800 KOIN");
const u8 gText_Scyther_5500Coins[] = _("SCYTHER{CLEAR_TO 0x4B}{FONT_SMALL} 5,500 KOIN");
const u8 gText_Porygon_9999Coins[] = _("PORYGON{CLEAR_TO 0x4B}{FONT_SMALL} 9,999 KOIN");
const u8 gText_Abra_120Coins[] = _("ABRA{CLEAR_TO 0x55}{FONT_SMALL} 120 KOIN");
const u8 gText_Clefairy_750Coins[] = _("CLEFAIRY{CLEAR_TO 0x55}{FONT_SMALL} 750 KOIN");
const u8 gText_Pinsir_2500Coins[] = _("PINSIR{CLEAR_TO 0x4B}{FONT_SMALL} 2,500 KOIN");
const u8 gText_Dratini_4600Coins[] = _("DRATINI{CLEAR_TO 0x4B}{FONT_SMALL} 4,600 KOIN");
const u8 gText_Porygon_6500Coins[] = _("PORYGON{CLEAR_TO 0x4B}{FONT_SMALL} 6,500 KOIN");
const u8 gText_NoThanks_2[] = _("PERGI");
const u8 gText_HelixFossil[] = _("FOSILINGKAR");
const u8 gText_DomeFossil[] = _("FOSILKUBAH");
const u8 gText_OldAmber[] = _("BATU GETAH");
const u8 gText_TradeCenter[] = _("PUSAT BARTER");
const u8 gText_Colosseum[] = _("COLOSSEUM");
const u8 gText_GameLinkCable[] = _("Game Link cable");
const u8 gText_Wireless[] = _("Nirkabel");
const u8 gText_ItemsPocket[] = _("SAKU BARANG");
const u8 gText_KeyItemsPocket[] = _("SAKU PENTING");
const u8 gText_PokeBallsPocket[] = _("SAKU BOLA");
const u8 gText_TmCase[] = _("KOTAK TM");
const u8 gText_BerryPouch_2[] = _("KANTONG BERI");
const u8 gText_Other[] = _("LAINNYA");
const u8 gText_OneIsland[] = _("PULAU SATU");
const u8 gText_TwoIsland[] = _("PULAU DUA");
const u8 gText_ThreeIsland[] = _("PULAU TIGA");
const u8 gText_FourIsland[] = _("PULAU EMPAT");
const u8 gText_FiveIsland[] = _("PULAU LIMA");
const u8 gText_SixIsland[] = _("PULAU ENAM");
const u8 gText_SevenIsland[] = _("PULAU TUJUH");
...
const u8 gText_2Tinymushrooms[] = _("2 JAMUR KECIL");
const u8 gText_1BigMushroom[] = _("1 JAMUR BESAR");
const u8 gText_SeviiIslands[] = _("SAPTA NUSA");
const u8 gText_NavelRock[] = _("BATU PUSAR");
const u8 gText_BirthIsland[] = _("NUSA KAWITAN");
const u8 gText_MiracleSeed_1000Coins[] = _("BIBIT AJAIB{CLEAR_TO 0x50}{FONT_SMALL}1,000 KOIN");
const u8 gText_Charcoal_1000Coins[] = _("ARANG{CLEAR_TO 0x50}{FONT_SMALL}1,000 KOIN");
const u8 gText_MysticWater_1000Coins[] = _("MYSTIC WATER{CLEAR_TO 0x50}{FONT_SMALL}1,000 KOIN");
const u8 gText_YellowFlute_1600Coins[] = _("SULINGKUNING{CLEAR_TO 0x50}{FONT_SMALL}1,600 KOIN");
const u8 gText_SmokeBall_800Coins[] = _("BOLA ASAP{CLEAR_TO 0x5A}{FONT_SMALL}800 KOIN");
...
const u8 gText_BoulderBadge[] = _("MEDALIBATU");
const u8 gText_CascadeBadge[] = _("MEDALIAIR");
const u8 gText_ThunderBadge[] = _("MEDALIPETIR");
const u8 gText_RainbowBadge[] = _("MEDALIWARNA");
const u8 gText_SoulBadge[] = _("MEDALISUKMA");
const u8 gText_MarshBadge[] = _("MEDALIRAWA");
const u8 gText_VolcanoBadge[] = _("MEDALIMERAPI");
const u8 gText_EarthBadge[] = _("MEDALIBUMI");
const u8 gText_1F[] = _("L1");
const u8 gText_2F[] = _("L2");
const u8 gText_3F[] = _("L3");
const u8 gText_4F[] = _("L4");
const u8 gText_5F[] = _("L5");
const u8 gText_6F[] = _("L6");
const u8 gText_7F[] = _("L7");
const u8 gText_8F[] = _("L8");
const u8 gText_9F[] = _("L9");
const u8 gText_10F[] = _("L10");
const u8 gText_11F[] = _("L11");
const u8 gText_B1F[] = _("LB1");
const u8 gText_B2F[] = _("LB2");
const u8 gText_B3F[] = _("LB3");
const u8 gText_B4F[] = _("LB4");
...
const u8 gText_ExitFromBox[] = _("Keluar dari BOX.");
const u8 gText_WhatDoYouWantToDo[] = _("Apa yang mau kamu lakukan?");
const u8 gText_PleasePickATheme[] = _("Pilih tema nya.");
const u8 gText_PickTheWallpaper[] = _("Pilih wallpaper.");
const u8 gText_PkmnIsSelected[] = _("{DYNAMIC 0x00} dipilih.");
const u8 gText_JumpToWhichBox[] = _("Lompat ke BOX yang mana?");
const u8 gText_DepositInWhichBox[] = _("Taruh ke BOX yang mana?");
const u8 gText_PkmnWasDeposited[] = _("{DYNAMIC 0x00} ditaruh.");
const u8 gText_BoxIsFull2[] = _("BOX nya penuh.");
const u8 gText_ReleaseThisPokemon[] = _("Buang POKéMON ini?");
const u8 gText_PkmnWasReleased[] = _("{DYNAMIC 0x00} dilepaskan.");
const u8 gText_ByeByePkmn[] = _("Dadah, {DYNAMIC 0x00}!");
const u8 gText_MarkYourPkmn[] = _("Tandai POKéMON mu.");
const u8 gText_ThatsYourLastPkmn[] = _("Itu POKéMON terakhirmu!");
const u8 gText_YourPartysFull[] = _("Party mu penuh!");
const u8 gText_YoureHoldingAPkmn[] = _("Kamu sedang memegang POKéMON!");
const u8 gText_WhichOneWillYouTake[] = _("Mana yang mau diambil?");
const u8 gText_YouCantReleaseAnEgg[] = _("Kamu tidak bisa membuang TELUR.");
const u8 gText_ContinueBoxOperations[] = _("Masih mengatur BOX?");
...
const u8 gText_PleaseRemoveTheMail[] = _("Ambil SURAT nya dulu.");
const u8 gText_GiveToAPkmn[] = _("KASIH ke POKéMON?");
const u8 gText_PlacedItemInBag[] = _("Disimpan ke dalam TAS.");
const u8 gText_BagIsFull2[] = _("TAS nya penuh.");
const u8 gText_PutItemInBag[] = _("Taruh ini ke dalam TAS?");
...
const u8 gPCText_Cancel[] = _("KEMBALI");
const u8 gPCText_Store[] = _("TARUH");
const u8 gPCText_Withdraw[] = _("AMBIL");
const u8 gPCText_Shift[] = _("TUKAR");
const u8 gPCText_Move[] = _("PINDAH");
const u8 gPCText_Place[] = _("TARUH");
const u8 gPCText_Summary[] = _("INFO");
const u8 gPCText_Release[] = _("LEPASKAN");
const u8 gPCText_Mark[] = _("TANDAI");
const u8 gPCText_Name[] = _("NAMA");
const u8 gPCText_Jump[] = _("LOMPAT");
const u8 gPCText_Wallpaper[] = _("WALLPAPER");
const u8 gPCText_Take[] = _("AMBIL");
const u8 gPCText_Give[] = _("KASIH");
const u8 gPCText_Switch[] = _("GANTI");
const u8 gPCText_Bag[] = _("TAS");
const u8 gPCText_Info[] = _("INFO");
const u8 gPCText_Scenery1[] = _("ALAM 1");
const u8 gPCText_Scenery2[] = _("ALAM 2");
const u8 gPCText_Scenery3[] = _("ALAM 3");
const u8 gPCText_Etcetera[] = _("LAINNYA");
const u8 gPCText_Forest[] = _("HUTAN");
const u8 gPCText_City[] = _("KOTA");
const u8 gPCText_Desert[] = _("GURUN");
const u8 gPCText_Savanna[] = _("DATARAN");
const u8 gPCText_Crag[] = _("BEBATUAN");
const u8 gPCText_Volcano[] = _("GN.BERAPI");
const u8 gPCText_Snow[] = _("SALJU");
const u8 gPCText_Cave[] = _("GUA");
const u8 gPCText_Beach[] = _("PANTAI");
const u8 gPCText_Seafloor[] = _("DASAR LAUT");
const u8 gPCText_River[] = _("SUNGAI");
const u8 gPCText_Sky[] = _("LANGIT");
const u8 gPCText_PolkaDot[] = _("BINTANG");
const u8 gPCText_Pokecenter[] = _("POKéCENTER");
const u8 gPCText_Machine[] = _("MESIN");
const u8 gPCText_Simple[] = _("POLOS");
const u8 gText_PC_WhatWouldYouLikeToDo[] = _("なにを しますか?");
const u8 gText_WithdrawPokemon[] = _("AMBIL POKéMON");
const u8 gText_DepositPokemon[] = _("TARUH POKéMON");
const u8 gText_MovePokemon[] = _("PINDAH POKéMON");
const u8 gText_MoveItems[] = _("PINDAH BARANG");
const u8 gText_SeeYa[] = _("DADAH!");
...
const u8 gText_YourProfile[] = _("Profil mu");
...
const u8 gText_YourName[] = _("NAMA MU?");
const u8 gText_BoxName[] = _("NAMA BOX?");
const u8 gText_PkmnsNickname[] = _(" dipanggil apa?");
const u8 gText_RivalsName[] = _("NAMA RIVAL?");
const u8 gText_MoveOkBack[] = _("{DPAD_ANY}PILIH {A_BUTTON}OK {B_BUTTON}KEMBALI");
const u8 gText_AlphabetUpperLower[] = _("");
const u8 gText_RegionMap_Space[] = _(" ");
const u8 gText_RegionMap_AButtonGuide[] = _("{A_BUTTON}PANDUAN");
const u8 gText_RegionMap_AButtonCancel[] = _("{A_BUTTON}TUTUP");
const u8 gText_RegionMap_AButtonCancel2[] = _("{A_BUTTON}TUTUP");
const u8 gText_RegionMap_AButtonSwitch[] = _("{A_BUTTON}GANTI");
const u8 gText_RegionMap_AButtonOK[] = _("{A_BUTTON}OK");
const u8 gText_RegionMap_DPadMove[] = _("{DPAD_ANY}GERAK");
const u8 gText_RegionMap_UpDownPick[] = _("{DPAD_UPDOWN}PILIH");
...
const u8 gText_PokeSum_MetInATrade_BoldGentleGrammar[] = _("sifatnya {DYNAMIC 0x00}.\nDidapat dari barteran.");
const u8 gText_PokeSum_FatefulEncounterMet[] = _("sifatnya {DYNAMIC 0x00}.\nMet in a fateful encounter when\nat {LV_2} {DYNAMIC 0x01}.");
...
const u8 gText_PokeSum_EggOrigin_Trade[] = _("Telur POKéMON ini didapat\ndari barteran.");
const u8 gText_PokeSum_EggHatch_LongTime[] = _("Sepertinya TELUR\nini perlu waktu\nlama untuk menetas.");
const u8 gText_PokeSum_EggHatch_SomeTime[] = _("Kalau menetas jadi\napa ya? Sepertinya\nmasih perlu waktu.");
const u8 gText_PokeSum_EggHatch_Soon[] = _("Sudah mulai bergerak.\nSeharusnya sebentar\nlagi sih..");
const u8 gText_PokeSum_EggHatch_AlmostReady[] = _("Sudah mulai bersuara.\nTELUR ini sudah\nsiap untuk menetas!");
const u8 gText_PokeSum_ATrade[] = _("barteran");
const u8 gText_Somewhere[] = _("suatu tempat");
const u8 gText_PokeSum_PageName_PokemonInfo[] = _("INFO POKéMON");
const u8 gText_PokeSum_PageName_PokemonSkills[] = _("KEMAMPUAN");
const u8 gText_PokeSum_PageName_KnownMoves[] = _("DAFTAR JURUS");
const u8 gText_PokeSum_NoData[] = _("Tidak ada data");
const u8 gText_PokeSum_ExpPoints[] = _("TOTAL EXP.");
const u8 gText_PokeSum_NextLv[] = _("LV. SELANJUTNYA");
const u8 gText_PokeSum_Controls_PageCancel[] = _("{DPAD_RIGHT}PINDAH {A_BUTTON}KEMBALI");
const u8 gText_PokeSum_Controls_Cancel[] = _("{A_BUTTON}KEMBALI");
const u8 gText_PokeSum_Controls_Page[] = _("{DPAD_LEFTRIGHT}PINDAH");
const u8 gText_PokeSum_Controls_PageDetail[] = _("{DPAD_LEFT}PINDAH {A_BUTTON}UBAH");
const u8 gText_PokeSum_Controls_PickSwitch[] = _("{DPAD_UPDOWN}PILIH {A_BUTTON}URUTKAN");
const u8 gText_PokeSum_Controls_Pick[] = _("{DPAD_UPDOWN}PILIH");
const u8 gText_PokeSum_Controls_PickDelete[] = _("{DPAD_UPDOWN}PILIH {A_BUTTON}HAPUS");
const u8 gText_PokeSum_HmMovesCantBeForgotten[] = _("Jurus HM tidak\nbisa dilupakan.");
...
const u8 gText_Var1sTrainerCard[] = _(" KARTU PELATIH");
const u8 gText_HallOfFameDebut[] = _("HALL OF FAME DEBUT  ");
const u8 gText_LinkBattles[] = _("BERTARUNG");
const u8 gText_LinkCableBattles[] = _("BERTARUNG KABEL");
const u8 gText_WinLossRatio[] = _("M:{CLEAR_TO 0x30}K:");
const u8 gText_PokemonTrades[] = _("POKéMON YANG DITUKAR");
...
const u8 gText_Option[] = _("PENGATURAN");
const u8 gText_TextSpeed[] = _("LAJU TEKS");
const u8 gText_BattleScene[] = _("ANIMASI BATTLE");
const u8 gText_BattleStyle[] = _("MODE BATTLE");
const u8 gText_Sound[] = _("SUARA");
const u8 gText_ButtonMode[] = _("MODE TOMBOL");
const u8 gText_Frame[] = _("BINGKAI");
const u8 gText_OptionMenuCancel[] = _("KEMBALI");
const u8 gText_TextSpeedSlow[] = _("LAMBAT");
const u8 gText_TextSpeedMid[] = _("SEDANG");
const u8 gText_TextSpeedFast[] = _("CEPAT");
...
const u8 gText_ButtonTypeHelp[] = _("BANTUAN");
const u8 gText_ButtonTypeLEqualsA[] = _("L=A");
const u8 gText_ButtonTypeLR[] = _("LR");
const u8 gText_FrameType[] = _("TIPE");
const u8 gText_PickSwitchCancel[] = _("{DPAD_UPDOWN}PILIH {DPAD_LEFTRIGHT}UBAH {A_BUTTON}{B_BUTTON}KEMBALI");
...
const u8 gText_SavingDontTurnOffThePower2[] = _("MENYIMPAN DATA…\nJANGAN MATIKAN DAYA.");

// Start menu option descriptions
const u8 gStartMenuDesc_Pokedex[] = _("Alat yang merekam informasi POKéMON\nsaat bertemu atau menangkap mereka.");
const u8 gStartMenuDesc_Pokemon[] = _("Lihat dan atur POKéMON yang kalian\nbawa dalam party.");
const u8 gStartMenuDesc_Bag[] = _("Dilengkapi dengan saku untuk menyimpan\nbarang yang kalian dapat atau beli.");
const u8 gStartMenuDesc_Player[] = _("Cek daftar medali, uang dan lainnya.");
const u8 gStartMenuDesc_Save[] = _("Simpan data perjalananmu saat ini agar\nbisa dilanjutkan nanti.");
const u8 gStartMenuDesc_Option[] = _("Ubah berbagai pengaturan game seperti\nkecepatan teks, bingkai jendela, dsb.");
const u8 gStartMenuDesc_Exit[] = _("Tutup jendela MENU ini.");
...
const u8 gText_LevelRoseTo[] = _(" naik ke level\n");
...
const u8 gText_Diploma_National[] = _("NASIONAL");
...
const u8 gString_Someone[] = _("SESEORANG");
const u8 gString_Help[] = _("BANTUAN");
...
ALIGNED(4) const u8 gText_Ghost[] = _("HANTU");
...
const u8 gText_ItGotAway[] = _("Yah.. kabur‥{PAUSE_UNTIL_PRESS}");
const u8 gText_Rooftop2[] = _("ATAP");
...
const u8 gText_HelpSystemControls_A_Next[] = _("{A_BUTTON}LANJUT");
const u8 gText_HelpSystemControls_PickOkEnd[] = _("{DPAD_UPDOWN}PILIH {A_BUTTON}BUKA {B_BUTTON}TUTUP");
const u8 gText_HelpSystemControls_AorBtoCancel[] = _("{A_BUTTON}{B_BUTTON}KEMBALI");
const u8 gText_HelpSystemControls_PickOkCancel[] = _("{DPAD_UPDOWN}PILIH {A_BUTTON}BUKA {B_BUTTON}KEMBALI");
...
const u8 gEasyChatGroupName_Greetings[] = _("SAPAAN");
const u8 gEasyChatGroupName_People[] = _("ORANG");
const u8 gEasyChatGroupName_Voices[] = _("SUARA");
const u8 gEasyChatGroupName_Speech[] = _("KATA");
const u8 gEasyChatGroupName_Endings[] = _("ENDING");
const u8 gEasyChatGroupName_Feelings[] = _("PERASAAN");
const u8 gEasyChatGroupName_Conditions[] = _("KONDISI");
const u8 gEasyChatGroupName_Actions[] = _("PERILAKU");
const u8 gEasyChatGroupName_Lifestyle[] = _("GAYA");
const u8 gEasyChatGroupName_Hobbies[] = _("HOBI");
const u8 gEasyChatGroupName_Time[] = _("WAKTU");
const u8 gEasyChatGroupName_Misc[] = _("LAINNYA");
...
const u8 gTradeText_Cancel[] = _("BATAL");
const u8 gTradeText_ChooseAPokemon[] = _("Pilih POKéMON.");
const u8 gTradeText_Summary[] = _("INFO");
const u8 gTradeText_Trade[] = _("TUKAR");
const u8 gText_CancelTrade[] = _("Batalkan pertukaran?");
const u8 gTradeText_PressBButtonToExit[] = _("Tekan tombol B untuk keluar.");
const u8 gText_TradeAction_Summary[] = _("INFO");
const u8 gText_TradeAction_Trade[] = _("TUKAR");
const u8 gText_Trade_CommunicationStandby[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Communication standby…\nPlease wait.");
const u8 gText_TradeHasBeenCanceled[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Pertukaran dibatalkan.");
...
const u8 gText_ByeByeVar1[] = _("Dadah, {STR_VAR_2}!");
const u8 gText_XSentOverY[] = _("{STR_VAR_1} mengirim {STR_VAR_3}.");
const u8 gText_TakeGoodCareOfX[] = _("Rawat {STR_VAR_3} baik-baik, ya!");
const u8 gText_From[] = _("Dari ");
