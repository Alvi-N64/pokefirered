const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_YOUNGSTER]           = _("BOCAH"),
    [TRAINER_CLASS_BUG_CATCHER]         = _("PEMBURU"),
    [TRAINER_CLASS_LASS]                = _("GADIS"),
    [TRAINER_CLASS_SAILOR]              = _("PELAUT"),
    [TRAINER_CLASS_CAMPER]              = _("PRAMUKA♂"),
    [TRAINER_CLASS_PICNICKER]           = _("PRAMUKA♀"),
    [TRAINER_CLASS_POKEMANIAC]          = _("MANIAK {PKMN}"),
    [TRAINER_CLASS_SUPER_NERD]          = _("KUTU BUKU"),
    [TRAINER_CLASS_HIKER]               = _("PENDAKI"),
    [TRAINER_CLASS_BIKER]               = _("GENG MOTOR"),
    [TRAINER_CLASS_BURGLAR]             = _("MALING"),
    [TRAINER_CLASS_ENGINEER]            = _("INSINYUR"),
    [TRAINER_CLASS_FISHERMAN]           = _("PEMANCING"),
    [TRAINER_CLASS_SWIMMER_M]           = _("PERENANG♂"),
    [TRAINER_CLASS_CUE_BALL]            = _("PREMAN"),
    [TRAINER_CLASS_GAMER]               = _("PENJUDI"),
    [TRAINER_CLASS_BEAUTY]              = _("BEAUTY"),
    [TRAINER_CLASS_SWIMMER_F]           = _("PERENANG♀"),
    [TRAINER_CLASS_PSYCHIC]             = _("ESPER"),
    [TRAINER_CLASS_ROCKER]              = _("ROCKER"),
    [TRAINER_CLASS_JUGGLER]             = _("PESULAP"),
    [TRAINER_CLASS_TAMER]               = _("TAMER"),
    [TRAINER_CLASS_BIRD_KEEPER]         = _("BIRD KEEPER"),
    [TRAINER_CLASS_BLACK_BELT]          = _("SABUK HITAM"),
    [TRAINER_CLASS_RIVAL_EARLY]         = _("RIVAL"),
    [TRAINER_CLASS_SCIENTIST]           = _("PENELITI"),
    [TRAINER_CLASS_BOSS]                = _("BOS"),
    [TRAINER_CLASS_LEADER]              = _("KETUA"),
    [TRAINER_CLASS_TEAM_ROCKET]         = _("TIM ROKET"),
    [TRAINER_CLASS_COOLTRAINER]         = _("COOLTRAINER"),
    [TRAINER_CLASS_ELITE_FOUR]          = _("EMPAT ELIT"),
    [TRAINER_CLASS_GENTLEMAN]           = _("BANGSAWAN"),
    [TRAINER_CLASS_RIVAL_LATE]          = _("RIVAL"),
    [TRAINER_CLASS_CHAMPION]            = _("JUARA"),
    [TRAINER_CLASS_CHANNELER]           = _("CENAYANG"),
    [TRAINER_CLASS_TWINS]               = _("SI KEMBAR"),
    [TRAINER_CLASS_COOL_COUPLE]         = _("COOL COUPLE"),
    [TRAINER_CLASS_YOUNG_COUPLE]        = _("PASANGAN"),
    [TRAINER_CLASS_CRUSH_KIN]           = _("PETARUNG"),
    [TRAINER_CLASS_SIS_AND_BRO]         = _("KAKAK ADIK"),
    [TRAINER_CLASS_PKMN_PROF]           = _("PROF. {PKMN}"),
    [TRAINER_CLASS_PLAYER]              = _("PLAYER"),
    [TRAINER_CLASS_CRUSH_GIRL]          = _("CRUSH GIRL"),
    [TRAINER_CLASS_TUBER]               = _("PELAMPUNG"),
    [TRAINER_CLASS_PKMN_BREEDER]        = _("PERAWAT {PKMN}"),
    [TRAINER_CLASS_PKMN_RANGER]         = _("PENJAGA {PKMN}"),
    [TRAINER_CLASS_AROMA_LADY]          = _("GADISPARFUM"),
    [TRAINER_CLASS_RUIN_MANIAC]         = _("RUIN MANIAC"),
    [TRAINER_CLASS_LADY]                = _("LADY"),
    [TRAINER_CLASS_PAINTER]             = _("PELUKIS"),
};
